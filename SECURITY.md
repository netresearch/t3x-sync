...
Use [GitHub Security Advisories](https://github.com/netresearch/t3x-sync/security/advisories/new) to report vulnerabilities privately.
...
This policy covers the `sync` TYPO3 extension code. For vulnerabilities in dependencies or TYPO3 core, please report to the respective upstream projects.
